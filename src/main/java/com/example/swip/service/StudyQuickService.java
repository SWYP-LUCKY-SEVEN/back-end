...
public class StudyQuickService {
    ...
    public List<QuickMatchResponse> quickFilteredStudy(QuickMatchFilter quickMatchFilter){
        List<QuickMatchResponse> FilteredStudyList = studyRepository.quickFilterStudy(quickMatchFilter);
